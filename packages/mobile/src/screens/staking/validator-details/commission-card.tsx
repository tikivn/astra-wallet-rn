...
export const CommissionsCard: FunctionComponent<{
    ...
    if (validator) {
        ...
        f = date.toLocaleTimeString("vi-VN") + " " + date.toLocaleDateString("vi-VN");
    }
    ...
    return (
        <Card style={containerStyle}>
            {validator ? (
                <CardBody>
                    <View style={style.flatten(["flex-row", "justify-evenly", "padding-y-12"])}>
                    ...
                    <CardDivider style={style.flatten(["background-color-gray-70", "margin-x-0"])}></CardDivider>
                    <View
                        style={style.flatten([
                            "flex-row",
                            "items-center",
