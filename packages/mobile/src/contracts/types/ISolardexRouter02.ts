...
export interface ISolardexRouter02Interface extends utils.Interface {
  functions: {
...
export interface ISolardexRouter02 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISolardexRouter02Interface;
