...
export class SignClientStore {
  ...
  protected *useWalletConnectEventManager() {
    ...
    useEffect(() => {
        ...
        this.signClient.on('session_proposal', onSessionProposal)
        this.signClient.on('session_request', onSessionRequest)
        // TODOs
        this.signClient.on('session_ping', data => console.log('ping', data))
        this.signClient.on('session_event', data => console.log('event', data))
        this.signClient.on('session_update', data => console.log('update', data))
        this.signClient.on('session_delete', data => console.log('delete', data))
